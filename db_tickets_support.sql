...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2021 at 05:53 AM
...
(4, '2021_10_06_052452_create_tb_users_table', 1),
(5, '2021_10_06_052512_create_tb_tickets_table', 1),
(6, '2021_10_06_052527_create_tb_companies_table', 1),
(7, '2021_10_06_052554_create_tb_user_company_table', 1);
...
CREATE TABLE `tb_tickets` (
  ...
  `TicketStatus` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `tb_user_company` (
  `UserAssignedId` int(10) UNSIGNED NOT NULL,
...
ALTER TABLE `tb_user_company`
  ADD PRIMARY KEY (`UserAssignedId`);
...
--
ALTER TABLE `tb_user_company`
  MODIFY `UserAssignedId` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
